...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\EpisodesRepository' => \App\Repositories\EloquentEpisodesRepository::class,
            'App\Repositories\SeriesRepository' => \App\Repositories\EloquentSeriesRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\joao\Desktop\Alura\Curso Laravel\Laravel - MVC\continuacao\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\joao\\Desktop\\Alura\\Curso Laravel\\Laravel - MVC\\continuacao\\public\\storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','autenticador',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','series.index','series.create','series.store',
'series.edit','series.update','series.destroy','seasons.index',
'episodes.index','episodes.update','login','signin','logout',
'users.create','users.store','storage.local',);
        registerArgumentsSet('views', 
'components.layout','components.series.form','episodes.index','login.index','mail.series-created',
'seasons.index','series.create','series.edit','series.index','users.create',
